...
const navigation: NavItem[] = [
  ...
  { section: "why", label: "Why Delta", description: "Why we built a lean knowledge-work harness" },
  { section: "product", label: "Product", description: "Test an agent in the Cockpit" },
  {
    section: "built-on",
    label: "Use cases",
    description: "See it running in production",
  },
